...
public class EnemyScript : MonoBehaviour
{
    ...
    void OnPlayerHit(EnemyScript target)
    {
        if (target == this)
        {
            ...
            StopMoving();
            playerCombat.LeapAttackSound(false);//set sound bool param
    ...
    public void TriggerAudio(int fmodParam)
    {
        
        //we only need to method so there's something to call, no need for any logic
    }
